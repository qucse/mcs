...
# Last run was from 0 to and including 218
start_step = 195
end_step = 2000
lr = 0.00001
momentum = 0.9
...
################################
model_path = './saved_models/cmtl_shtechA_200.h5'
...
for epoch in range(start_step, end_step + 1):
    ...
    for blob in data_loader:
        ...
        if step % disp_interval == 0:
            ...
            log_text = 'epoch: %4d, step %4d, Time: %.4fs, gt_cnt: %4.1f, et_cnt: %4.1f' % (epoch, step, 1. / fps, gt_count, et_count)
